...
@Component({
  ...
  templateUrl: './resident-add.page.html',
  styleUrls: ['./resident-add.page.scss'],
})
export class ResidentAddPage implements OnInit {
  user_type: string;
  community_id: string;
  user_id: string;
  code: any;
  ...
  saveForm(form){
    ...
    this.authService.common('addResident',meeting_post).subscribe((res) => {
      if(res['success']=='1'){
