...
export class AddParkingPage implements OnInit {
  ...
  ionViewWillEnter(): void {
    ...
    this.authService.common('getFlat',meeting_post).subscribe((res) => {
      if(res['success']=='1'){
  ...
  save(form){
    ...
    meeting_post.append('parking', form.value.parking);    
    this.authService.common('addParking',meeting_post).subscribe((res) => {
      if(res['success']=='1'){
        this.ionLoader.hideLoader();
